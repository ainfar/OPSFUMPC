...
<!--<body class="antialiased">
    ...
    <div style = "background-color:#ccccff; margin-left: 20%; margin-right: 20%; margin-top: 5%;  padding: 31px; border-radius: 30px">

        <!-- <div class="container" >
                <div class="row">
                    <div class="a">
                    <h4>Welcome to UMP Printing Service</h4>
                </div>   
        ...
        <div class="row">
            <div class="column">
                <img src="umpgambang.jpg" alt="UMPGambang" style="width:100%; height:86%" >
            ...
            <div class="column">
                <img src="umppekan.jpg" alt="UMPPekan" style="width:100%">
                <div class="w3-container" style="text-align:center">
                <h5>UMP Pekan</h5>
            </div>
        </div>
